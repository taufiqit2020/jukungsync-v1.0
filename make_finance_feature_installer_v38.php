...
$files = [
    ...
    'resources/views/reports/print-expenses.blade.php',
];
...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Modul Pengeluaran & Barang Masuk (Keuangan) Berhasil Diinstal!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>File fitur berhasil disalin. <strong>Tinggal 1 langkah lagi!</strong> Silakan klik tombol di bawah ini untuk memperbarui database (Migrasi) agar fitur Pengeluaran siap digunakan.</p>\";\n";
$php .= "    echo \"<a href='/jalankan-otomatis' style='display:inline-block;padding:12px 28px;background:#e11d48;color:white;text-decoration:none;border-radius:8px;font-weight:bold;font-size:16px;'>Jalankan Update Database (Klik Disini)</a>\";\n";
$php .= "    echo \"</div>\";\n";
$php .= "    @unlink(__FILE__);\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_finance_feature_v38.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_finance_feature_v38.php', $php);
echo "✅ installer_finance_feature_v38.md and installer_finance_feature_v38.php created successfully!\n";
