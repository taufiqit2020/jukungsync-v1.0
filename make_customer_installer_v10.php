<?php
$b64_create = base64_encode(file_get_contents('resources/views/customers/create.blade.php'));
$b64_edit = base64_encode(file_get_contents('resources/views/customers/edit.blade.php'));
$b64_admin = base64_encode(file_get_contents('resources/views/layouts/admin.blade.php'));
...
$php .= "try {\n";
$php .= "    if (!is_dir(\$laravelRoot . '/resources/views/customers')) mkdir(\$laravelRoot . '/resources/views/customers', 0755, true);\n";
$php .= "    file_put_contents(\$laravelRoot . '/resources/views/customers/create.blade.php', base64_decode('$b64_create'));\n";
$php .= "    file_put_contents(\$laravelRoot . '/resources/views/customers/edit.blade.php', base64_decode('$b64_edit'));\n";
$php .= "    file_put_contents(\$laravelRoot . '/resources/views/layouts/admin.blade.php', base64_decode('$b64_admin'));\n\n";
...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Perbaikan Formulir & Menu Selesai!</h1>\";\n";
$php .= "    echo \"<p style='color:#4b5563;'>Halaman Tambah Customer dan Edit Customer sudah aktif. Menu Data Customer juga sudah muncul di bilah kiri.</p>\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v10.md', $md);
