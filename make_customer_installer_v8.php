...
$php .= "try {\n";
$php .= "    file_put_contents(\$laravelRoot . '/routes/web.php', base64_decode('$b64_web'));\n\n";
...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Perbaikan Akhir Selesai!</h1>\";\n";
$php .= "    echo \"<p style='color:#4b5563;'>Semua kode ganda pada rute sudah dihapus dan halaman bisa diakses sepenuhnya.</p>\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v8.md', $md);
