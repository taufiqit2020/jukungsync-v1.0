...
$files = [
    ...
    'resources/views/reports/movements.blade.php',
    ...
    'resources/views/catalog/orders.blade.php',
...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Deployment JukungSync V1.1 & Laporan Mutasi Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;'>Seluruh file baru, modifikasi, laporan mutasi, info sosial media cetak, dan e-catalog premium telah dipasang.</p>\n\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v20.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v20.php', $php);
echo "installer_customer_v20.md and installer_customer_v20.php created successfully with premium e-catalog!\n";
