...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Update Label Laporan Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>Tanda tangan bagian bawah pada seluruh dokumen cetak laporan sekarang telah diubah dari 'Mengetahui Bendahara,' menjadi 'Mengetahui KEPALA ADMINISTRASI DAN KEUANGAN,'.</p>\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_reports_role_update_v36.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_reports_role_update_v36.php', $php);
echo "✅ installer_reports_role_update_v36.md and installer_reports_role_update_v36.php created successfully!\n";
