...
$php .= "    echo \"<p style='margin:0.5rem 0 0;opacity:0.9;font-size:0.9rem;'>Pembaruan Laporan Cetak Gaji Karyawan Per PT (v65)</p>\\n\";  \n";
$php .= "    echo \"</div>\";  \n";
...
file_put_contents('C:/Users/USER/.gemini/antigravity/scratch/JukungSync-V1.1/public/installer_v65.php', $php);
echo "✅ installer_v65.php compiled successfully!\n";
?>
