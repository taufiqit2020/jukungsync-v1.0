...
try {
    ...
    $log .= '✔ Berhasil menyalin ' . $copiedCount . ' file media ke folder publik.\n';
    ...
    echo "<p style='margin:0.5rem 0 0;opacity:0.8;font-size:0.9rem;'>Penyimpanan Fisik Tanpa Symlink Diaktifkan (v53)</p>
";  
    echo "</div>";  
    ...
    echo "<p style='font-size:0.875rem;color:#4b5563;'>Disk <code>public</code> telah dipindahkan ke folder fisik <code>public/storage</code>. Semua file media lama berhasil disalin.</p>";
    echo "<p style='font-size:0.875rem;color:#1d4ed8;font-weight:600;'>Silakan buka <a href='/cek_gambar_produksi.php' target='_blank'>cek_gambar_produksi.php</a> untuk melihat diagnostik gambar jika masih ada gambar yang belum muncul.</p>";
    echo "</div>";  
