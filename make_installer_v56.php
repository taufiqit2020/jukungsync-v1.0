...
$php .= "    echo \"<h1>Pembaruan Berhasil (v56)!</h1><pre style='background:#f3f4f6;padding:1rem;'>\" . htmlspecialchars(\$log) . \"</pre>\";\n";
$php .= "} catch (\\Exception \$e) {\n";
$php .= "    echo \"<h1 style='color:red;'>Error:</h1><pre>\" . \$e->getMessage() . \"</pre>\";\n";
$php .= "}\n";

file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_v56.php', $php);
file_put_contents('C:/Users/USER/.gemini/antigravity/scratch/JukungSync-V1.1/public/installer_v56.php', $php);
echo "✅ installer_v56.php created successfully!\n";
?>
