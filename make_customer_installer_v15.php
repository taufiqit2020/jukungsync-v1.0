<?php
$b64_index_view = base64_encode(file_get_contents('resources/views/inventory-movements/index.blade.php'));
...
$php .= "try {\n";
$php .= "    file_put_contents(\$laravelRoot . '/resources/views/inventory-movements/index.blade.php', base64_decode('$b64_index_view'));\n\n";
...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Fitur Status Invoice Berhasil Ditambahkan!</h1>\";\n";
$php .= "    echo \"<p style='color:#4b5563;'>Sekarang Anda bisa melihat langsung di tabel Mutasi, mana yang belum dibuat invoice-nya dan mana yang sudah menjadi invoice.</p>\";\n";
$php .= "    echo \"<a href='/inventory-movements' style='display: inline-block; padding: 10px 20px; background: #991b1b; color: white; text-decoration: none; border-radius: 5px; margin-top: 20px;'>Kembali ke Mutasi Keluar</a>\";\n";
$php .= "    echo \"</div>\";\n\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v15.md', $md);
