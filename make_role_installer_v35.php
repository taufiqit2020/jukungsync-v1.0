...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Update Perubahan Label Role Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>Label role Bendahara telah diubah menjadi KEPALA ADMINISTRASI DAN KEUANGAN di seluruh sistem.</p>\";\n";
$php .= "    echo \"<a href='/dashboard' style='display:inline-block;padding:10px 24px;background:#1e293b;color:white;text-decoration:none;border-radius:8px;font-weight:bold;'>Buka Dashboard</a>\";\n";
$php .= "    echo \"</div>\";\n";
$php .= "    @unlink(__FILE__);\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_role_update_v35.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_role_update_v35.php', $php);
echo "✅ installer_role_update_v35.md and installer_role_update_v35.php created successfully!\n";
