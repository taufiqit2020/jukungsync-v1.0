<?php
$b64_invoice_ctrl = base64_encode(file_get_contents('app/Http/Controllers/InvoiceController.php'));
...
$php .= "try {\n";
$php .= "    file_put_contents(\$laravelRoot . '/app/Http/Controllers/InvoiceController.php', base64_decode('$b64_invoice_ctrl'));\n\n";
...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Perbaikan Filter Tarik Mutasi Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#4b5563;'>Kini, saat Anda membuat Invoice Baru, sistem <b>hanya</b> akan menarik otomatis data mutasi keluar yang memang ditujukan untuk Klien/Customer. Mutasi internal seperti 'KANTOR' tidak akan ditarik lagi ke dalam invoice.</p>\";\n";
$php .= "    echo \"<a href='/invoices' style='display: inline-block; padding: 10px 20px; background: #991b1b; color: white; text-decoration: none; border-radius: 5px; margin-top: 20px;'>Kembali ke Invoice</a>\";\n";
$php .= "    echo \"</div>\";\n\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v16.md', $md);
