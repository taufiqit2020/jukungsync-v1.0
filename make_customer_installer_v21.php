...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Update Sistem Kategori Pelanggan V21 Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>Sistem 3 tier pelanggan (Reguler / Member / Premium), logika harga grosir+diskon, info rekening BSI, dan metode pembayaran telah dipasang.</p>\";\n";
...
$php .= "    echo \"</div>\";\n";
$php .= "    echo \"<a href='/dashboard' style='display:inline-block;padding:10px 24px;background:#1e293b;color:white;text-decoration:none;border-radius:8px;font-weight:bold;'>Masuk ke Dashboard</a>\";\n";
$php .= "    echo \"</div>\";\n";
$php .= "    @unlink(__FILE__);\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v21.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v21.php', $php);
echo "✅ installer_customer_v21.md and installer_customer_v21.php created successfully!\n";
