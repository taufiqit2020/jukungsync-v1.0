...
$php .= "// 1. Cari Folder Root Laravel secara dinamis\n";
$php .= "\$dir = __DIR__;\n";
$php .= "\$laravelRoot = null;\n\n";
$php .= "if (file_exists(\$dir . '/artisan')) {\n";
$php .= "    \$laravelRoot = \$dir;\n";
$php .= "} elseif (file_exists(\$dir . '/../artisan')) {\n";
$php .= "    \$laravelRoot = realpath(\$dir . '/..');\n";
$php .= "} elseif (file_exists(\$dir . '/../laravel/artisan')) {\n";
$php .= "    \$laravelRoot = realpath(\$dir . '/../laravel');\n";
$php .= "}\n\n";

$php .= "if (!\$laravelRoot) {\n";
$php .= "    die(\"<h1 style='color:red;'>Error:</h1> File 'artisan' tidak ditemukan. Sistem tidak bisa menentukan folder root Laravel Anda.\");\n";
$php .= "}\n\n";

$php .= "// 2. Fungsi untuk menulis file\n";
...
$php .= "try {\n";
$php .= "    // 3. Tulis semua file baru ke tempatnya masing-masing\n";
...
$php .= "    // 4. Hapus Cache secara manual (Hard Delete) agar tidak ada rute yang nyangkut\n";
...
$php .= "    // 5. Load Laravel untuk menjalankan perintah database (Migrate)\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v4.md', $md);
