                ...
                <div class="px-8 py-6 max-h-[80vh] overflow-y-auto">
                    ...
                    <form action="{{ route('invoices.store') }}" method="POST" id="invoice-form">
                        ...
                        <div class="mb-4 bg-yellow-50 border border-yellow-200 p-3 rounded-lg flex items-center gap-3">
                            <input type="checkbox" id="gunakan_grosir" x-model="isGrosir" @change="recalculateAllPrices()" class="w-5 h-5 text-tema-marun border-gray-300 rounded focus:ring-tema-marun focus:ring-2">
