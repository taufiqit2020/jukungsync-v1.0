...
class ProductController extends Controller
{
    ...
    public function destroy(Product $product)
    {
        try {
            ...
            if ($e->getCode() == '23000') {
                return redirect()->route('products.index')->with('error', 'Barang tidak dapat dihapus karena sudah memiliki riwayat transaksi (Invoice/Pergerakan Stok).');
            }
            return redirect()->route('products.index')->with('error', 'Terjadi kesalahan sistem saat menghapus barang.');
        }
    }
}
