...
$php .= "    echo \"<p style='margin:0.5rem 0 0;opacity:0.8;font-size:0.9rem;'>Auto SKU (Stock Keeping Unit) Berdasarkan Kategori</p>\";  \n";
$php .= "    echo \"</div>\";  \n";
...
$php .= "    echo \"<li><strong>ProductController.php</strong> — Method nextSku untuk menghitung nomor urut SKU otomatis</li>\";  \n";
$php .= "    echo \"<li><strong>create.blade.php (products)</strong> — Script untuk memicu fetch otomatis ketika kategori dipilih</li>\";  \n";
$php .= "    echo \"<li><strong>web.php (routes)</strong> — Rute API untuk next-sku</li>\";  \n";
$php .= "    echo \"</ul></div>\";  \n";
$php .= "    echo \"<div style='background:#f0fdf4;border:1.5px solid #86efac;border-radius:1rem;padding:1.25rem;margin-bottom:1.25rem;'>\";  \n";
$php .= "    echo \"<h3 style='margin:0 0 0.75rem;color:#166534;font-size:0.9rem;font-weight:800;'>🔍 Fitur SKU Otomatis:</h3>\";  \n";
$php .= "    echo \"<ul style='margin:0;padding:0 0 0 1.25rem;color:#166534;font-size:0.8rem;line-height:1.8;'>\";  \n";
$php .= "    echo \"<li>Membuat SKU otomatis berurutan sesuai kategori yang dipilih</li>\";  \n";
$php .= "    echo \"<li>ATK -> A-080, Kebersihan -> B-022, Perlengkapan Ibu&Bayi -> C-012, IPSRS -> E-005, dll.</li>\";  \n";
$php .= "    echo \"<li>Menyesuaikan otomatis dengan data barang yang sudah ada</li>\";  \n";
$php .= "    echo \"</ul></div>\";  \n";
$php .= "    echo \"<div style='text-align:center;'>\";  \n";
$php .= "    echo \"<a href='/products/create' style='display:inline-flex;align-items:center;gap:0.5rem;padding:0.875rem 2rem;background:linear-gradient(135deg,#ca8a04,#d97706);color:#111827;text-decoration:none;border-radius:0.875rem;font-weight:800;font-size:0.95rem;box-shadow:0 4px 16px rgba(202,138,4,0.35);'>🏷️ Buka Halaman Tambah Barang</a>\";  \n";
$php .= "    echo \"</div>\";  \n";
$php .= "    echo \"</div>\";  \n";
...
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_sku_auto_v50.php', $php);
file_put_contents('C:/Users/USER/.gemini/antigravity/scratch/JukungSync-V1.1/public/installer_sku_auto_v50.php', $php);
echo "✅ installer_sku_auto_v50.php created successfully!\n";
?>
