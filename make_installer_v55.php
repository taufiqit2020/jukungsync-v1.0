...
$php .= "    echo \"<h1 style='margin:0;font-size:1.5rem;font-weight:900;'>Pembaruan SKU Otomatis Berhasil!</h1>\";  \n";
$php .= "    echo \"<p style='margin:0.5rem 0 0;opacity:0.8;font-size:0.9rem;'>Pembaruan SKU Otomatis (v55)</p>\n\";  \n";
$php .= "    echo \"</div>\";  \n";
...
$php .= "    echo \"<p style='font-size:0.875rem;color:#4b5563;'>Kode SKU otomatis sekarang strictly dimetakan sesuai ketentuan kategori baru (ATK: A-, Kebersihan: B-, Ibu/Bayi: C-, IPSRS: D-, Lainnya: E-).</p>\n\";\n";
$php .= "    echo \"</div>\";  \n";
$php .= "    echo \"<div style='text-align:center;'>\";  \n";
$php .= "    echo \"<a href='/products/create' style='display:inline-flex;align-items:center;gap:0.5rem;padding:0.875rem 2rem;background:linear-gradient(135deg,#ca8a04,#d97706);color:#111827;text-decoration:none;border-radius:0.875rem;font-weight:800;font-size:0.95rem;box-shadow:0 4px 16px rgba(202,138,4,0.35);'>➕ Tambah Barang Baru</a>\";  \n";
$php .= "    echo \"</div>\";  \n";
$php .= "    echo \"</div>\";  \n";
...
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_sku_auto_v55.php', $php);
file_put_contents('C:/Users/USER/.gemini/antigravity/scratch/JukungSync-V1.1/public/installer_sku_auto_v55.php', $php);
echo "✅ installer_sku_auto_v55.php created successfully!\n";
?>
