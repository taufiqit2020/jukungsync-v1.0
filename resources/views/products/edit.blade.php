                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="harga_modal" id="harga_modal" value="{{ old('harga_modal', intval($product->harga_modal)) }}" class="pl-9 w-full rounded-xl border-gray-300 shadow-sm focus:border-red-900 focus:ring focus:ring-red-900 focus:ring-opacity-20 py-2.5 px-3 border text-sm font-bold" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400 font-bold text-sm">Rp</span>
                            <input type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual', intval($product->harga_jual)) }}" class="pl-9 w-full rounded-xl border-gray-300 shadow-sm focus:border-red-900 focus:ring focus:ring-red-900 focus:ring-opacity-20 py-2.5 px-3 border text-sm font-bold" required>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative mb-2">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400 font-bold text-sm">Rp</span>
                            <input type="number" name="harga_grosir" id="harga_grosir" value="{{ old('harga_grosir', intval($product->harga_grosir)) }}" class="pl-9 w-full rounded-xl border-gray-300 shadow-sm focus:border-red-900 focus:ring focus:ring-red-900 focus:ring-opacity-20 py-2.5 px-3 border text-sm font-bold">
                        </div>
