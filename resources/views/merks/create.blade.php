...
<div class="bg-white shadow rounded-lg p-6 max-w-2xl mx-auto">
    <div class="mb-6 border-b pb-4">
        <h2 class="text-xl font-semibold text-gray-800">Tambah Merk Baru</h2>
    </div>
    ...
    <form action="{{ route('merks.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nama_merk" id="nama_merk" value="{{ old('nama_merk') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-tema-marun focus:ring focus:ring-tema-marun focus:ring-opacity-50 py-2 px-3 border" required>
            @error('nama_merk')
