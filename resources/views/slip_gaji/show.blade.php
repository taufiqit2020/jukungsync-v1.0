        ...
        <div class="payslip-container">
            ...
            <div class="payslip-half">
                ...
                <div>
                    ...
                    <div class="mb-1 p-1.5 grid grid-cols-[60%_40%] bg-slate-900 text-white rounded text-[8.5px] font-black uppercase tracking-wide relative z-10" style="background-color: #111827;">
                    ...
                    <!-- Terbilang -->
                    <div class="text-[7.5px] italic font-bold border-b border-dashed border-black pb-0.5 mb-1 relative z-10">
                        Terbilang: {{ \App\Helpers\TerbilangHelper::terbilang($slipGaji->total_gaji) }} Rupiah
                    </div>

                    <!-- Catatan -->
                    @if($slipGaji->catatan)
                    <div class="text-[7.5px] border border-dashed border-gray-400 p-1 rounded mb-1 relative z-10">
                ...
                <div>
                    ...
                    <div class="mt-1 relative z-10">
                        <div class="flex justify-between text-[8px] font-bold text-center">
                            <div class="w-36">
                                <p class="uppercase mb-14">DIREKTUR</p>
                                <p class="font-bold uppercase pb-0.5 inline-block w-full">HJ. NORMAULIDA, S.H.</p>
                            </div>
                            <div class="w-36">
                                <p class="uppercase mb-14">PENERIMA / KARYAWAN</p>
                    ...
                    <div class="p-1 text-center text-[7px] font-semibold tracking-wide mt-2" style="border-radius: 4px; background-color: #111827; color: white; line-height: 1.3;">
