...
<body class="p-4 md:p-8">
    ...
    <div class="no-print max-w-4xl mx-auto mb-6 flex justify-between items-center bg-slate-900 text-white p-4 rounded-xl shadow-md">
        <div>
            <h2 class="text-sm font-bold">Cetak Slip Gaji</h2>
    ...
    <div class="payslip-page">
        <div class="payslip-container">
            ...
            <div>
                ...
                <!-- Judul Dokumen -->
                <div class="flex justify-between items-center mb-3 border-b border-black pb-1.5">
                    <h2 class="text-sm font-black uppercase tracking-widest">SLIP GAJI KARYAWAN</h2>
                </div>

                <!-- Informasi Detail Karyawan -->
                <div class="grid grid-cols-2 gap-4 mb-4 text-[10px] text-black border border-black p-2.5 rounded bg-transparent relative z-10">
                ...
                <div class="space-y-3 mb-4 relative z-10">
                    <!-- Pendapatan Table -->
                    <table class="my-table text-[10px]">
                        <thead>
                            <tr>
                ...
                <div class="mb-3 p-2 flex justify-between items-center bg-slate-900 text-white rounded text-[11px] font-black uppercase tracking-wide relative z-10" style="background-color: #111827;">
                    <span>Gaji Bersih Diterima (Net Salary) = A - B</span>
                    <span class="text-sm">Rp {{ number_format($slipGaji->total_gaji, 0, ',', '.') }}</span>
                </div>

                <!-- Terbilang -->
                <div class="text-[10px] italic font-bold border-b border-dashed border-black pb-1.5 mb-3 relative z-10">
                    Terbilang: {{ \App\Helpers\TerbilangHelper::terbilang($slipGaji->total_gaji) }} Rupiah
                </div>

                <!-- Catatan -->
                @if($slipGaji->catatan)
                <div class="text-[9px] border border-dashed border-gray-400 p-2 rounded mb-2 relative z-10">
            ...
            <div>
                ...
                <div class="p-2 text-center text-[8.5px] font-semibold tracking-wide mt-6" style="border-radius: 4px; background-color: #111827; color: white; line-height: 1.4;">
                    <div>Alamat Kantor : Jl. Panglima Batur Banjarbaru Utara, Banjarbaru Kalimantan Selatan</div>
                    <div class="mt-0.5 text-gray-300 text-[7.5px]">
