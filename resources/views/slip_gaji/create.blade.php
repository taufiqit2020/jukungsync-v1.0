...
<div class="container mx-auto px-4 py-6 max-w-4xl">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Buat Slip Gaji Baru</h1>
            <p class="text-sm text-gray-600">Buat rincian gaji baru untuk karyawan</p>
        </div>
    ...
    <form action="{{ route('slip-gaji.store') }}" method="POST" id="salaryForm" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input type="text" value="{{ $nomorSlip }}" disabled class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-mono font-bold text-gray-500 focus:outline-none">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Nama Lengkap Karyawan</label>
                    <input type="text" name="nama_karyawan" value="{{ old('nama_karyawan') }}" required placeholder="Contoh: Budi Santoso" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Jabatan</label>
                    <input type="text" name="jabatan" value="{{ old('jabatan') }}" placeholder="Contoh: Staf Administrasi" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Periode</label>
                    <input type="text" name="periode" value="{{ old('periode', \Carbon\Carbon::now()->translatedFormat('F Y')) }}" required placeholder="Contoh: Juni 2026" class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok', 0) }}" required min="0" class="calc-trigger w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Lembur (Rp)</label>
                        <input type="number" name="lembur" id="lembur" value="{{ old('lembur', 0) }}" min="0" class="calc-trigger w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Tunjangan / Bonus (Rp)</label>
                        <input type="number" name="tunjangan_bonus" id="tunjangan_bonus" value="{{ old('tunjangan_bonus', 0) }}" min="0" class="calc-trigger w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="number" name="bpjs_kesehatan" id="bpjs_kesehatan" value="{{ old('bpjs_kesehatan', 0) }}" min="0" class="calc-trigger w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">BPJS Ketenagakerjaan (Rp)</label>
                        <input type="number" name="bpjs_ketenagakerjaan" id="bpjs_ketenagakerjaan" value="{{ old('bpjs_ketenagakerjaan', 0) }}" min="0" class="calc-trigger w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-indigo-900 to-slate-900 rounded-xl p-6 text-white flex flex-col md:flex-row items-center justify-between gap-4 shadow-md">
            <div>
                <p class="text-xs font-bold text-indigo-300 uppercase tracking-wider">Estimasi Total Pendapatan Bersih</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <textarea name="catatan" rows="3" placeholder="Tambahkan catatan jika diperlukan..." class="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('catatan') }}</textarea>
        </div>
