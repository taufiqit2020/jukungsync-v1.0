...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Update Form Register V33 Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>Form registrasi telah dikembalikan sesuai screenshot dengan textarea alamat tunggal dan uppercase label.</p>\";\n";
$php .= "    echo \"<a href='/register' style='display:inline-block;padding:10px 24px;background:#1e293b;color:white;text-decoration:none;border-radius:8px;font-weight:bold;margin-right:10px;'>Cek Halaman Register</a>\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v33.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_customer_v33.php', $php);
echo "✅ installer_customer_v33.md and installer_customer_v33.php created successfully!\n";
