...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Pembaruan Input Barang Masuk Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>Fitur input Harga Jual, pembaruan harga master otomatis, tombol pilihan Harga Master/Terakhir, serta penambahan barang manual kini aktif.</p>\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_finance_invoice_layout_v45.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_finance_invoice_layout_v45.php', $php);
echo "✅ installer_finance_invoice_layout_v45.md and installer_finance_invoice_layout_v45.php created successfully!\n";
