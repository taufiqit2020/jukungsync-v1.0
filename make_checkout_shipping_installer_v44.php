...
$php .= "    echo \"<h1 style='color:#16a34a;'>✅ Pembaruan Ongkir E-Catalog Berhasil!</h1>\";\n";
$php .= "    echo \"<p style='color:#374151;max-width:600px;margin:0 auto 20px;'>Pembaruan aturan ongkos kirim (Banjarbaru & Martapura Rp 0, Banjarmasin Rp 25.000) telah dipasang secara otomatis.</p>\";\n";
$php .= "    echo \"<a href='/catalog/checkout' style='display:inline-block;padding:12px 28px;background:#111827;color:#FBBF24;text-decoration:none;border-radius:8px;font-weight:bold;font-size:16px;'>Buka Halaman Checkout</a>\";\n";
$php .= "    echo \"</div>\";\n";
...
$md = "```php\n" . $php . "\n```";
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_finance_invoice_layout_v44.md', $md);
file_put_contents('C:/Users/USER/.gemini/antigravity/brain/f12d4254-b154-471c-b76a-aa67f4e9fcf6/installer_finance_invoice_layout_v44.php', $php);
echo "✅ installer_finance_invoice_layout_v44.md and installer_finance_invoice_layout_v44.php created successfully!\n";
