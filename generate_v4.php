...
<body class="max-w-5xl mx-auto p-4 md:p-8 relative">
    ...
    <!-- MAIN INVOICE TABLE -->
    <table class="w-full table-border border-collapse {{ \$isInternal ? 'text-[10px]' : 'text-sm' }} text-center bg-transparent inner-table">
        ...
        <tbody class="bg-transparent">
            ...
            <tr>
                ...
                <td class="py-2 px-2 text-right">Rp {{ number_format(\$item->harga_jual_snapshot, 0, ',', '.') }}</td>
                <td class="py-2 px-2 text-right">Rp {{ number_format(\$item->total_harga, 0, ',', '.') }}</td>
            ...
            <tr class="font-bold border-t-2 border-black">
                ...
                <td class="py-2 px-2 text-right">Rp {{ number_format(\$invoice->sub_total, 0, ',', '.') }}</td>
            ...
            <tr class="font-bold">
                ...
                <td class="py-2 px-2 text-right">Rp {{ number_format(\$invoice->pajak_ppn, 0, ',', '.') }}</td>
            </tr>
            <tr class="font-bold">
                <td colspan="8" class="py-2 px-4 text-right border-r">Total Tagihan</td>
                <td class="py-2 px-2 text-right">Rp {{ number_format(\$invoice->total_tagihan, 0, ',', '.') }}</td>
            </tr>
            <!-- Terbilang -->
